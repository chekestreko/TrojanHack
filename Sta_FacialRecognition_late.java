...
class Sta_FacialRecognition
{
	...
	public static Vector<String> vec = new Vector<String>(5);
...
//                saveImage(croppedImage, name);
            ...
            Imgproc.putText(image, "Student: " + identifyFace(croppedImage), face.tl(), Font.BOLD, 2, color);
