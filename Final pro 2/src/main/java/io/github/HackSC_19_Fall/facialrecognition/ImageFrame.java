...
class VideoFrame
{
    ...
    private JPanel createColorPanel()
    {
        ...
        String[] colorOptions = {"BLUE", "CYAN", "GREEN", "MAGENTA", "ORANGE", "RED","BLACK"};
    ...
    Scalar getTextColor()
    {
        return new Scalar(color.getBlue(), color.getRed(), color.getGreen());
    }
